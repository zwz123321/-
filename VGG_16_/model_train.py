...
def train_val_data_process():
    train_data = FashionMNIST(root=data_path, train=True, transform=transforms.Compose([transforms.Resize(size = 224), transforms.ToTensor()]), download = True)
...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    torch.save(best_model_wts, 'D:/python代码调试/项目实战/VGG-16/best_model.pth')
...
if __name__ == "__main__":
    ...
    train_process = train_model_process(VGG16, train_dataloader, val_dataloader, 2)
