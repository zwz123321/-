...
def test_data_process():
    test_data = FashionMNIST(root=data_path, train=False, transform=transforms.Compose([transforms.Resize(size = 28), transforms.ToTensor()]), download = True)
...
if __name__=="__main__":
    ...
    model.load_state_dict(torch.load('D:/python代码调试\项目实战/卷积神经网络实战LeNet_5/best_model.pth'))
    #加载测试数据
