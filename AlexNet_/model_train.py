...
# 示例路径（请替换为你自己的路径）
data_path = 'D:/python代码调试/项目实战/AlexNet/data'

def train_val_data_process():
    train_data = FashionMNIST(root=data_path, train=True, transform=transforms.Compose([transforms.Resize(size = 227), transforms.ToTensor()]), download = True)
...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    torch.save(best_model_wts, 'D:/python代码调试/项目实战/AlexNet/best_model.pth')
...
if __name__ == "__main__":
    ...
    train_process = train_model_process(AlexNet, train_dataloader, val_dataloader, 2)
